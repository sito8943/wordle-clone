...
const sanitizeCounter = (value: number): number => {
  ...
  return (
    ...
    >
      <svg
        ...
        role="img"
        aria-hidden="true"
        className={`${iconClassName} ${isActive ? "fire-streak-icon-active" : "fire-streak-icon-idle"}`}
      >
        <defs>
