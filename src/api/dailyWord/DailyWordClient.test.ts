...
const PREVIOUS_STORAGE_KEY = `${DAILY_WORD_STORAGE_KEY_PREFIX}:${PREVIOUS_DATE}`;
const PREVIOUS_MEANING_STORAGE_KEY = `${DAILY_MEANING_STORAGE_KEY_PREFIX}:${PREVIOUS_DATE}:PUENTE`;
