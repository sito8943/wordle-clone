...
const WordListDialog = ({
  ...
  return (
    <Dialog
      ...
      title={t("play.wordListDialog.title")}
      description={t("play.wordListDialog.description", {
    ...
    >
      <div className="mt-4">
        ...
        >
          {t("play.wordListDialog.searchLabel")}
        </label>
        <input
          id="word-list-search"
          type="search"
          ...
          placeholder={t("play.wordListDialog.searchPlaceholder")}
