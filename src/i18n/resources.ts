    ...
    translation: {
      ...
      challenges: {
        ...
        names: {
          ...
          no_repeat_n_letters: "No Repeat N Letters",
        ...
        descriptions: {
          ...
          no_repeat_n_letters: `Do not repeat letters in guess rows (N=${CHALLENGE_DEFAULT_SIMPLE_NO_REPEAT_N_LETTERS})`,
    ...
    translation: {
      ...
      challenges: {
        ...
        names: {
          ...
          no_repeat_n_letters: "Sin repetir N letras",
        ...
        descriptions: {
          ...
          no_repeat_n_letters: `No repitas letras en tus intentos (N=${CHALLENGE_DEFAULT_SIMPLE_NO_REPEAT_N_LETTERS})`,
